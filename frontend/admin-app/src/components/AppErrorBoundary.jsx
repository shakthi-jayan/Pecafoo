...
class AppErrorBoundary extends Component {
  ...
  componentDidCatch(error, errorInfo) {
    console.error('Admin app error boundary caught an error.', error, errorInfo);
  }
      ...
      return (
        <div className="page" style={{ display: 'grid', placeItems: 'center', padding: '32px 20px' }}>
          <div className="card" style={{ maxWidth: 420, width: '100%', textAlign: 'center', padding: 24 }}>
            ...
            <h1 style={{ fontSize: '1.5rem', marginBottom: 10 }}>Admin console unavailable</h1>
            <p style={{ color: 'var(--text-secondary)', marginBottom: 16 }}>
              The admin app hit an unexpected error. Reload the page to recover.
            </p>
