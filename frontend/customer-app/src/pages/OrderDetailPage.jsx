...
const OrderDetailPage = () => {
    ...
    return (
        <PageContainer padding="0">
            ...
            {/* Sticky Actions */}
            <div style={{ position: 'fixed', bottom: '85px', left: 0, right: 0, padding: 'var(--space-4)', background: 'linear-gradient(to top, rgba(255,255,255,1) 0%, rgba(255,255,255,0.9) 70%, rgba(255,255,255,0) 100%)', zIndex: 100, display: 'flex', flexDirection: 'column', gap: 'var(--space-3)', maxWidth: '1200px', margin: '0 auto' }}>
