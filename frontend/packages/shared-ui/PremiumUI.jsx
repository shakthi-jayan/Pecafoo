...
export * from './components/data-display/index';

// Legacy Wrappers (To prevent immediate crashes before Phase 1)
import { HeroBanner, SectionHeader as NewSectionHeader, MetricCard as NewMetricCard } from './components/layout/index';
import { MetricCard as DataMetricCard, Avatar, HorizontalScroller, ProfileHeader } from './components/data-display/index';
